...
Essa seção é para aqueles usuários que queiram entender e corrigir o erro "Couldn't allocate runtime area". É mais comum em Z390, X99 e X299.

* Observação: é necessário usar o OpenCore. O Clover não é mais suportado neste guia.
