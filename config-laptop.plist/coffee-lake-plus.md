# Notebook Coffee Lake Plus e Comet Lake

| Suporte | Versão |
| :--- | :--- |
| Suporte Inicial no macOS ([CFL](https://en.wikipedia.org/wiki/Coffee_Lake) (em inglês)) | macOS 10.13 High Sierra |
| Suporte Inicial no macOS ([CML](https://en.wikipedia.org/wiki/Comet_Lake_(microprocessor)) (em inglês)) | macOS 10.15 Catalina |
...
* **SetupVirtualMap**: YES
  * Corrige as chamadas de `SetVirtualAddresses` para endereços virtuais, mas não deve ser necessário em CPUs Skylake ou mais novas. Alguns firmwares, como os da Gigabyte, talvez ainda necessitem e causarão *kernel panic* sem isso.
* **SyncRuntimePermissions**: YES
...
Neste exemplo de Coffee Lake Plus, a SMBIOS do MacBookPro16,1 será utilizada. Isso é intencional, por questões de compatibilidade. É mais ou menos assim (observe que as SMBIOS exigem o macOS 10.15 Catalina):
