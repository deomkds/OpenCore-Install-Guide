...
| Suporte | Versão |
| :--- | :--- |
| Suporte Inicial no macOS | macOS 10.12 Sierra |
...
| ------------------- | ---- | ------- |
| **00001B59** | Notebook | Recomendado para a HD 615, HD 620, HD 630, HD 640 e HD 650. |
| **00001659** | Notebook | Valor alternativo para 00001B59 caso ocorram problemas de aceleração. Recomendado para todas as HD e UHD 620 em NUCs. |
| **0000C087** | Notebook | Recomendado para a UHD 617 em CPUs Amber Lakee e para a UHD 620 em CPUs Kaby Lake R. |
| **00001E59** | NUC | Recomendado para a HD 615. |
| **00001B59** | NUC | Recomendado para a HD 630. |
| **02002659** | NUC | Recomendado para a HD 640/650. |

#### Observações Sobre a Configuração

* Para todos os usuários da UHD 620 (Kaby Lake-R), será necessário falsificar o `device-id`:

| Chave | Tipo | Valor |
| :--- | :--- | :--- |
| device-id | Data | 16590000 |

* Para todos os usuários de HD 6XX (não se aplica para UHD): existem alguns pequenos problemas com saída de vídeo que pode causar um *kernel panic* ao conectar alguma coisa. Aqui estão alguns patches para mitigar isso (créditos: Rehabman):
  * 0306 para 0105 (um dia alguém vai explicar em detalhes o que isso faz).
...
* 0204 para 0105 (um dia alguém vai explicar em detalhes o que isso faz).
...
Neste exemplo de Kaby Lake example, a SMBIOS do MacBookPro14,1 será utilizada. Isso é intencional, por questões de compatibilidade. É mais ou menos assim:
