# Notebook Clarksfield e Arrandale

| Suporte | Versão |
| :--- | :--- |
| Suporte Inicial no macOS | Mac OS X 10.6.3 Snow Leopard |
| Observação 1 | Arrandale's iGPU is only officially supported up-to macOS 10.13 |
| Observação 2 | A maioria das placas Clarksfield e Arrandale não suportam UEFI. |
...
Ao configurar a GPU integrada, simplesmente adicione os valores abaixo na entrada `PciRoot(0x0)/Pci(0x2,0x0)`:
...
* **Observação**: os drivers para Iron Lake da Apple suportam somente monitores LVDS e **não** eDP.
...
Neste exemplo de Arrandale, a SMBIOS do MacBookPro6,1 será utilizada. Isso é intencional, por questões de compatibilidade. É mais ou menos assim:

| SMBIOS | Tipo de CPU | Tamanho do Monitor |
| :--- | :--- | :--- |
| MacBookPro6,1 | Quad Core 45w (Alto Desempenho) | 17" |
| MacBookPro6,2 | Quad Core 45w (Entrada) | 15" |
