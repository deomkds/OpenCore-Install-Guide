...
| ------------------- | ---- | ------- |
| **00001619** | Notebook | Recomendado para a HD 515, HD 520, HD 530, HD 540, HD 550 e P530. |
| **00001E19** | Notebook | Valor alternativo para HD 515 caso ocorram problemas com o valor anterior. |
| **00001B19** | Notebook | Recomendado para a HD 510. |
| **00001E19** | NUC | Recomendado para a HD 515. |
| **02001619** | NUC | Recomendado para a  HD 520/530. |
| **02002619** | NUC | Recomendado para a  HD 540/550. |
| **05003B19** | NUC | Recomendado para a  HD 580. |

#### Observações Sobre a Configuração

* Usuários da HD 510 precisarão falsificar o `device-id`:

| Chave | Tipo | Valor |
| :--- | :--- | :--- |
| device-id | Data | 02190000 |

* Para a HD 550 e P530 (e potencialmente todas as GPUs integradas da série P), talvez seja necessário usar `device-id`=`16190000`:
...
Neste exemplo de Skylake, a SMBIOS do  MacBookPro13,1 será utilizada. Isso é intencional, por questões de compatibilidade. É mais ou menos assim:

| SMBIOS | Tipo de CPU | Tipo de GPU | Tamanho do Monitor | Touch ID |
| :--- | :--- | :--- | :--- | :--- |
| MacBook9,1 | Dual Core 7w (Entrada) | GPU integrada: HD 515 | 12" | Não |
