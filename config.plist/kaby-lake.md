...
| :--- | :--- |
| 00001259 | Usado quando a GPU integrada de desktops é usada para exibir as imagens no monitor. |
| 03001259 | Usado quando a GPU integrada de desktop é utilizada somente para tarefas de computação e não exibe imagens em um monitor. |
...
Neste exemplo de Kaby Lake, a SMBIOS do iMac18,1 será utilizada. Isso é intencional, por questões de compatibilidade. Existem duas principais SMBIOS usadas em computadores com CPUs Kaby Lake:

| SMBIOS | Hardware |
| :--- | :--- |
| iMac18,1 | Usada em computadores que utilizam a GPU integrada para exibir imagens no monitor. |
| iMac18,3 | Usada em computadores que utilizam uma GPU dedicada para exibir imagens no monitor, nos quais a GPU integrada é usada somente para tarefas de computação. |
