...
| Suporte | Versão |
| :--- | :--- |
| Suporte Inicial no macOS | Mac OS X 10.5.6 Leopard |
...
Necessário para "falsificar" CPUs não suportadas. Porém, CPUs Nehalem são oficialmente suportadas e nenhum patch é requerido.
...
Neste exemplo de Nehalem, existem algumas opções para escolha:

| SMBIOS | Hardware |
| :--- | :--- |
| MacPro5,1 | macOS 10.14 Mojave ou mais antigo. |
| MacPro6,1 | macOS 10.15 Catalina ou mais novo. |
